namespace EdgeBot.Classes.Common
{
    static class Colors
    {
        ...
        public static readonly string DarkBlue = (char)3 + "02";
        public static readonly string DarkGreen = (char)3 + "03";
        ...
        public static readonly string DarkGray = (char)3 + "14";
        public static readonly string LightGray = (char)3 + "15";
    }
}
