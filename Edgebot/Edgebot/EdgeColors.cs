namespace Edgebot
{
    class EdgeColors
    {
        ...
        public static string DarkBlue = (char)3 + "02";
        public static string DarkGreen = (char)3 + "03";
        ...
        public static string DarkGray = (char)3 + "14";
        public static string LightGray = (char)3 + "15";
    }
}
